...
export const areaAccent: Record<SchemaArea, AreaAccent> = {
  ...
  mode: {
    ...
    navIndicatorBg: 'bg-indigo-50',
    navIndicatorRing: 'ring-indigo-100',
    navIndicatorText: 'text-indigo-700',
    ...
    cardExpandHover: 'group-hover/fc:bg-indigo-100 group-hover/fc:text-indigo-700',
